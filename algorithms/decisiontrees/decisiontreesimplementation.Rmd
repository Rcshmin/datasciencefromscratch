...
split_data(data = iris, split_column = "Petal.Width", split_value = 0.2)
```
...
get_potential_splits(data = iris[,c(4,5)])
determine_best_split(data = iris[,c(4,5)], potential_splits = get_potential_splits(iris[,c(4,5)]), mode = "entropy")

...
Before we begin creating our helper function for the decision tree classifier, it important to define what form the input data will be in for our algorithm. We wil use the following form 

\begin{bmatrix}
  x_{1} & x_{2} & x_{3} & x_{4} & \dots & Y
\end{bmatrix}


## Train-test split

We will first code a helper function to split our data into a training data set, which will be used to train the decision tree, and then a testing data set, which will be used to test how well the decision tree performs
